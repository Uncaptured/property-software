...
class DesktopSplashScaffold extends StatefulWidget {
  const DesktopSplashScaffold({super.key});

  @override
  State<DesktopSplashScaffold> createState() => _DesktopSplashScaffoldState();
}

class _DesktopSplashScaffoldState extends State<DesktopSplashScaffold> with SingleTickerProviderStateMixin {
        ...
        children: [
          ...
          Center(
            child: Column(
              ...
              children: [
                const Text(
                  'UNCAPTURED REAL-ESTATE', // Main text
