...
class TabletSplashScaffold extends StatefulWidget {
  const TabletSplashScaffold({super.key});

  @override
  State<TabletSplashScaffold> createState() => _TabletSplashScaffoldState();
}

class _TabletSplashScaffoldState extends State<TabletSplashScaffold> with SingleTickerProviderStateMixin {
