...
//
// class MobileSplashScaffold extends StatelessWidget {
//   const MobileSplashScaffold({super.key});
//
//   @override
...
//           children: [
//
//             MyNewPinkButton(width: 200, title:"wewe", onPressFunction: (){}),
//
//             Text(
//               "HELLOW HOW ARE U",
//               style: TextStyle(
...
class MobileSplashScaffold extends StatefulWidget {
  const MobileSplashScaffold({super.key});

  @override
  State<MobileSplashScaffold> createState() => _MobileSplashScaffoldState();
}

class _MobileSplashScaffoldState extends State<MobileSplashScaffold> with SingleTickerProviderStateMixin {
