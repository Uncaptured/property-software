...
class TabletLeaseScaffold extends StatefulWidget {
  const TabletLeaseScaffold({super.key});

  @override
  State<TabletLeaseScaffold> createState() => _TabletLeaseScaffoldState();
}

class _TabletLeaseScaffoldState extends State<TabletLeaseScaffold> {
  int pageIndex = 0;
