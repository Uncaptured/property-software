...
class MinTabletLeaseScaffold extends StatefulWidget {
  const MinTabletLeaseScaffold({super.key});

  @override
  State<MinTabletLeaseScaffold> createState() => _MinTabletLeaseScaffoldState();
}

class _MinTabletLeaseScaffoldState extends State<MinTabletLeaseScaffold> {
  int pageIndex = 0;
