...
class TabletTenantScaffold extends StatefulWidget {
  const TabletTenantScaffold({super.key});

  @override
  State<TabletTenantScaffold> createState() => _TabletTenantScaffoldState();
}

class _TabletTenantScaffoldState extends State<TabletTenantScaffold> {
  int pageIndex = 0;
