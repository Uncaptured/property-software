...
class MinTabletTenantScaffold extends StatefulWidget {
  const MinTabletTenantScaffold({super.key});

  @override
  State<MinTabletTenantScaffold> createState() => _MinTabletTenantScaffoldState();
}

class _MinTabletTenantScaffoldState extends State<MinTabletTenantScaffold> {
  int pageIndex = 0;
