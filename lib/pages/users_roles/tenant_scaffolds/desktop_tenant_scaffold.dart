...
import 'package:flutter_real_estate/pages/users_roles/user_dashboards_fragment/user_tenant_dashboard_fragment.dart';
import 'package:flutter_real_estate/pages/users_roles/users_fragments_pages/user_tenant_fragment.dart';


class DesktopTenantScaffold extends StatefulWidget {
  const DesktopTenantScaffold({super.key});

  @override
  State<DesktopTenantScaffold> createState() => _DesktopTenantScaffoldState();
}

class _DesktopTenantScaffoldState extends State<DesktopTenantScaffold> {
  ...
  void initState() {
    super.initState();
    _screens = [
      UserTenantDashboardFragment(onSelectPage: _selectPage),
      UserTenantFragment(),
      ProfileFragment()
    ];
  }
            ...
            child: Column(
              children: [
                ...
                DashboardLink(
                  ...
                  text: "Tenants",
                  isActive: pageIndex == 1, // Active when pageIndex is 3
                  changeIndex: () {
                    _selectPage(1);
                  },
                ),
