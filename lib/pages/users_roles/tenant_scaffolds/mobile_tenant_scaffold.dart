...
class MobileTenantScaffold extends StatefulWidget {
  const MobileTenantScaffold({super.key});

  @override
  State<MobileTenantScaffold> createState() => _MobileTenantScaffoldState();
}

class _MobileTenantScaffoldState extends State<MobileTenantScaffold> {
  int pageIndex = 0;
