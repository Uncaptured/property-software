...
import 'package:flutter_real_estate/pages/users_roles/users_fragments_pages/user_profile_fragment.dart';
import 'package:flutter_real_estate/pages/users_roles/users_fragments_pages/users_collection_fragment.dart';

import '../user_dashboards_fragment/user_collection_dashboard_fragment.dart';


class DesktopCollectionsScaffold extends StatefulWidget {
  const DesktopCollectionsScaffold({super.key});

  @override
  State<DesktopCollectionsScaffold> createState() => _DesktopCollectionsScaffoldState();
}

class _DesktopCollectionsScaffoldState extends State<DesktopCollectionsScaffold> {
  ...
  void initState() {
    super.initState();
    _screens = [
      UserCollectionDashboardFragment(onSelectPage: _selectPage),
            ...
            child: Column(
              children: [
                ...
                DashboardLink(
                  ...
                  text: "Collections",
                  isActive: pageIndex == 1, // Active when pageIndex is 5
                  changeIndex: () {
                    _selectPage(1);
                  },
                ),
