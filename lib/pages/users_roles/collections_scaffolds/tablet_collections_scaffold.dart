...
class TabletCollectionsScaffold extends StatefulWidget {
  const TabletCollectionsScaffold({super.key});

  @override
  State<TabletCollectionsScaffold> createState() => _TabletCollectionsScaffoldState();
}

class _TabletCollectionsScaffoldState extends State<TabletCollectionsScaffold> {
  int pageIndex = 0;
