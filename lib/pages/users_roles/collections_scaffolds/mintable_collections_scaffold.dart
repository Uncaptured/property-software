...
class MinTabletCollectionsScaffold extends StatefulWidget {
  const MinTabletCollectionsScaffold({super.key});

  @override
  State<MinTabletCollectionsScaffold> createState() => _MinTabletCollectionsScaffoldState();
}

class _MinTabletCollectionsScaffoldState extends State<MinTabletCollectionsScaffold> {
  int pageIndex = 0;
