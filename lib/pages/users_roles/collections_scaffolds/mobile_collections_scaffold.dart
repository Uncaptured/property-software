...
class MobileCollectionsScaffold extends StatefulWidget {
  const MobileCollectionsScaffold({super.key});

  @override
  State<MobileCollectionsScaffold> createState() => _MobileCollectionsScaffoldState();
}

class _MobileCollectionsScaffoldState extends State<MobileCollectionsScaffold> {
  int pageIndex = 0;
