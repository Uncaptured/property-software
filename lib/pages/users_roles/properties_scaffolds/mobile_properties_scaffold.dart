...
class MobilePropertiesScaffold extends StatefulWidget {
  const MobilePropertiesScaffold({super.key});

  @override
  State<MobilePropertiesScaffold> createState() => _MobilePropertiesScaffoldState();
}

class _MobilePropertiesScaffoldState extends State<MobilePropertiesScaffold> {
  int pageIndex = 0;
