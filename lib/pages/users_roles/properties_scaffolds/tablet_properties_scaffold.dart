...
class TabletPropertiesScaffold extends StatefulWidget {
  const TabletPropertiesScaffold({super.key});

  @override
  State<TabletPropertiesScaffold> createState() => _TabletPropertiesScaffoldState();
}

class _TabletPropertiesScaffoldState extends State<TabletPropertiesScaffold> {
  int pageIndex = 0;
