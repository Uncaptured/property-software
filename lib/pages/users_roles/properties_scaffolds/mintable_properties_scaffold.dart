...
class MinTabletPropertiesScaffold extends StatefulWidget {
  const MinTabletPropertiesScaffold({super.key});

  @override
  State<MinTabletPropertiesScaffold> createState() => _MinTabletPropertiesScaffoldState();
}

class _MinTabletPropertiesScaffoldState extends State<MinTabletPropertiesScaffold> {
  int pageIndex = 0;
