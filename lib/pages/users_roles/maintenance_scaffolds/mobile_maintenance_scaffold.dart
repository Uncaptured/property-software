...
class MobileMaintenanceScaffold extends StatefulWidget {
  const MobileMaintenanceScaffold({super.key});

  @override
  State<MobileMaintenanceScaffold> createState() => _MobileMaintenanceScaffoldState();
}

class _MobileMaintenanceScaffoldState extends State<MobileMaintenanceScaffold> {
  int pageIndex = 0;
