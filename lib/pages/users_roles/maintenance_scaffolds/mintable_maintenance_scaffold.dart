...
class MinTabletMaintenanceScaffold extends StatefulWidget {
  const MinTabletMaintenanceScaffold({super.key});

  @override
  State<MinTabletMaintenanceScaffold> createState() => _MinTabletMaintenanceScaffoldState();
}

class _MinTabletMaintenanceScaffoldState extends State<MinTabletMaintenanceScaffold> {
  int pageIndex = 0;
