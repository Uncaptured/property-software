...
class TabletMaintenanceScaffold extends StatefulWidget {
  const TabletMaintenanceScaffold({super.key});

  @override
  State<TabletMaintenanceScaffold> createState() => _TabletMaintenanceScaffoldState();
}

class _TabletMaintenanceScaffoldState extends State<TabletMaintenanceScaffold> {
  int pageIndex = 0;
