...
class UserPropertyUnitDashboardFragment extends StatefulWidget {
  final Function(int) onSelectPage;

  UserPropertyUnitDashboardFragment({
    super.key,
    required this.onSelectPage,
  });

  @override
  State<UserPropertyUnitDashboardFragment> createState() => _UserPropertyUnitDashboardFragmentState();
}

class _UserPropertyUnitDashboardFragmentState extends State<UserPropertyUnitDashboardFragment> {
