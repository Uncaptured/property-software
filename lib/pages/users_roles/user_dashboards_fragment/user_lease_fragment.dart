...
class UserLeaseDashboardFragment extends StatefulWidget {
  final Function(int) onSelectPage;

  UserLeaseDashboardFragment({
    super.key,
    required this.onSelectPage,
  });

  @override
  State<UserLeaseDashboardFragment> createState() => _UserLeaseDashboardFragmentState();
}

class _UserLeaseDashboardFragmentState extends State<UserLeaseDashboardFragment> {
