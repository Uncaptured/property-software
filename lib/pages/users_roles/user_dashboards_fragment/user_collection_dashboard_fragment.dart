...
class UserCollectionDashboardFragment extends StatefulWidget {
  final Function(int) onSelectPage;

  UserCollectionDashboardFragment({
    super.key,
    required this.onSelectPage,
  });

  @override
  State<UserCollectionDashboardFragment> createState() => _UserCollectionDashboardFragmentState();
}

class _UserCollectionDashboardFragmentState extends State<UserCollectionDashboardFragment> {
