...
class UserTenantDashboardFragment extends StatefulWidget {
  final Function(int) onSelectPage;

  UserTenantDashboardFragment({
    super.key,
    required this.onSelectPage,
  });

  @override
  State<UserTenantDashboardFragment> createState() => _UserTenantDashboardFragmentState();
}

class _UserTenantDashboardFragmentState extends State<UserTenantDashboardFragment> {
