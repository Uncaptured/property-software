...
class UserCollectionFragment extends StatefulWidget {
  UserCollectionFragment({super.key});

  @override
  State<UserCollectionFragment> createState() => _UserCollectionFragmentState();
}

class _UserCollectionFragmentState extends State<UserCollectionFragment> {
  bool isLoading = true;
