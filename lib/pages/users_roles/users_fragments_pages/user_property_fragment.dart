...
class UserPropertyFragment extends StatefulWidget {
  UserPropertyFragment({super.key});

  @override
  State<UserPropertyFragment> createState() => _UserPropertyFragmentState();
}

class _UserPropertyFragmentState extends State<UserPropertyFragment> {
  bool isLoading = true;
